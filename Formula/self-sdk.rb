...
class SelfSdk < Formula
  ...
  url "https://artifactregistry.googleapis.com/download/v1/projects/principal-oxide-204416/locations/europe/repositories/artifacts/files/self-sdk:#{version}:self-sdk-aarch64-apple-darwin-0.28.0.tar.gz:download"
